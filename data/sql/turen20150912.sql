...
INSERT INTO `t_auth_item_child` VALUES ('auth/auth','auth/auth/config'),('auth/auth','auth/auth/index'),('auth/auth-item','auth/auth-item/create'),('auth/auth-item','auth/auth-item/delete'),('auth/auth-item','auth/auth-item/index'),('auth/auth-item','auth/auth-item/update'),('auth/auth-item','auth/auth-item/view'),('cms/ad','cms/ad/index'),('cms/ad-type','cms/ad-type/'),('cms/ad-type','cms/ad-type/index'),('cms/ad-type','cms/ad-type/switch-stauts'),('cms/column','cms/column/create'),('cms/column','cms/column/index'),('cms/column','cms/column/update'),('cms/column','cms/column/view'),('cms/download','cms/download/'),('cms/download','cms/download/index'),('cms/img','cms/img/index'),('cms/page','cms/page/index'),('cms/page','cms/page/ueditor'),('cms/page','cms/page/update'),('cms/page','cms/page/view'),('cms/post','cms/post/index'),('GM','auth/auth'),('GM','auth/auth-item'),('GM','cms/ad'),('GM','cms/ad-type'),('GM','cms/column'),('GM','cms/download'),('GM','cms/img'),('GM','cms/page'),('GM','cms/post'),('GM','user/common'),('GM','user/user'),('help/help','help/help/create'),('help/help','help/help/delete'),('help/help','help/help/index'),('help/help','help/help/update'),('help/help','help/help/view'),('user/common','user/common/default'),('user/user','user/user/create'),('user/user','user/user/index'),('user/user','user/user/update');
...
INSERT INTO `t_extend_link` VALUES (1,1,'腾讯','生活精彩，在线更精彩','http://mat1.gtimg.com/www/iskin960/qqcomlogo.png','http://www.qq.com/',1,255,0,1,0),(2,1,'百度','百度一下，你就知道','http://www.baidu.com/img/baidu_sylogo1.gif','http://www.baidu.com/',2,255,0,1,0),(3,1,'phpMyWind','我们追求速度与舒适度','','http://phpmywind.com/',3,255,0,1,0);
...
CREATE TABLE `t_extend_link_type` (
  ...
  `updated_at` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='友链分类';

#
# Data for table "t_extend_link_type"
#

INSERT INTO `t_extend_link_type` VALUES (1,0,'默认分类',1,1,0,0,0);
...
INSERT INTO `t_help` VALUES (1,'栏目帮助','column_help','faf','fafdf','',1,0,0,1442030195);
