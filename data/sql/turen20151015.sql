...
INSERT INTO `t_auth_item_child` VALUES ('auth/auth','auth/auth/config'),('auth/auth','auth/auth/index'),('auth/auth-item','auth/auth-item/create'),('auth/auth-item','auth/auth-item/delete'),('auth/auth-item','auth/auth-item/index'),('auth/auth-item','auth/auth-item/update'),('auth/auth-item','auth/auth-item/view'),('cms/ad','cms/ad/delete'),('cms/ad','cms/ad/index'),('cms/ad','cms/ad/switch-status'),('cms/ad-type','cms/ad-type/'),('cms/ad-type','cms/ad-type/create'),('cms/ad-type','cms/ad-type/delete'),('cms/ad-type','cms/ad-type/index'),('cms/ad-type','cms/ad-type/switch-status'),('cms/ad-type','cms/ad-type/switch-stauts'),('cms/ad-type','cms/ad-type/update'),('cms/cms-page','cms/cms-page/index'),('cms/column','cms/column/'),('cms/column','cms/column/create'),('cms/column','cms/column/delete'),('cms/column','cms/column/index'),('cms/column','cms/column/sizzle.min.map'),('cms/column','cms/column/switch-status'),('cms/column','cms/column/switch-stauts'),('cms/column','cms/column/update'),('cms/column','cms/column/uploadify'),('cms/column','cms/column/view'),('cms/download','cms/download/'),('cms/download','cms/download/delete'),('cms/download','cms/download/index'),('cms/download','cms/download/switch-status'),('cms/flag','cms/flag/create'),('cms/flag','cms/flag/index'),('cms/flag','cms/flag/sizzle.min.map'),('cms/flag','cms/flag/update'),('cms/flag','cms/flag/view'),('cms/img','cms/img/index'),('cms/img','cms/img/switch-status'),('cms/img','cms/img/update'),('cms/page','cms/page/index'),('cms/page','cms/page/switch-status'),('cms/page','cms/page/ueditor'),('cms/page','cms/page/update'),('cms/page','cms/page/view'),('cms/post','cms/post/'),('cms/post','cms/post/create'),('cms/post','cms/post/delete'),('cms/post','cms/post/index'),('cms/post','cms/post/switch-status'),('cms/post','cms/post/switch-stauts'),('cms/post','cms/post/update'),('cms/post','cms/post/view'),('customer/customer-address','customer/customer-address/index'),('customer/customer-group','customer/customer-group/'),('customer/customer-group','customer/customer-group/index'),('debug/default','debug/default/view'),('dist/img','dist/img/default-50x50.gif'),('extend/comment','extend/comment/create'),('extend/comment','extend/comment/index'),('extend/comment','extend/comment/view'),('extend/fragment','extend/fragment/create'),('extend/fragment','extend/fragment/delete'),('extend/fragment','extend/fragment/index'),('extend/fragment','extend/fragment/switch-status'),('extend/fragment','extend/fragment/switch-stauts'),('extend/job','extend/job/create'),('extend/job','extend/job/delete'),('extend/job','extend/job/index'),('extend/job','extend/job/switch-status'),('extend/job','extend/job/switch-stauts'),('extend/job','extend/job/update'),('extend/link','extend/link/create'),('extend/link','extend/link/delete'),('extend/link','extend/link/index'),('extend/link','extend/link/switch-status'),('extend/link-type','extend/link-type/create'),('extend/link-type','extend/link-type/delete'),('extend/link-type','extend/link-type/index'),('extend/link-type','extend/link-type/switch-status'),('extend/link-type','extend/link-type/switch-stauts'),('extend/link-type','extend/link-type/update'),('extend/link-type','extend/link-type/view'),('extend/message','extend/message/create'),('extend/message','extend/message/delete'),('extend/message','extend/message/index'),('extend/message','extend/message/switch-status'),('extend/message','extend/message/switch-stauts'),('extend/message','extend/message/update'),('extend/nav','extend/nav/'),('extend/nav','extend/nav/1'),('extend/nav','extend/nav/create'),('extend/nav','extend/nav/delete'),('extend/nav','extend/nav/index'),('extend/nav','extend/nav/sizzle.min.map'),('extend/nav','extend/nav/status'),('extend/nav','extend/nav/switch-status'),('extend/nav','extend/nav/switch-stauts'),('extend/nav','extend/nav/update'),('extend/nav','extend/nav/view'),('GM','auth/auth'),('GM','auth/auth-item'),('GM','cms/ad'),('GM','cms/ad-type'),('GM','cms/column'),('GM','cms/download'),('GM','cms/img'),('GM','cms/page'),('GM','cms/post'),('GM','user/common'),('GM','user/user'),('help/help','help/help/create'),('help/help','help/help/delete'),('help/help','help/help/index'),('help/help','help/help/switch-stauts'),('help/help','help/help/update'),('help/help','help/help/view'),('order/call','order/call/create'),('order/call','order/call/delete'),('order/call','order/call/index'),('order/call','order/call/update'),('order/call','order/call/view'),('order/info','order/info/create'),('order/info','order/info/delete'),('order/info','order/info/index'),('order/info','order/info/update'),('order/info','order/info/view'),('system/cascade-data','system/cascade-data/index'),('system/config','system/config/'),('system/config','system/config/config'),('user/common','user/common/'),('user/common','user/common/about'),('user/common','user/common/captcha'),('user/common','user/common/default'),('user/common','user/common/login'),('user/common','user/common/logout'),('user/user','user/user/create'),('user/user','user/user/index'),('user/user','user/user/update');
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='栏目表';

#
# Data for table "t_cms_column"
#

INSERT INTO `t_cms_column` VALUES (1,0,'0,',1,'','网站公告','','','','','','','',43,1,0,0,1441065395),(2,0,'0,',1,'about','关于我们','','','','','','','',26,1,0,0,1441065470),(4,0,'0,',2,'','新闻动态','','','','','asdfaw','','',45,1,0,0,1441065473),(5,0,'0,',3,'','产品展示','','','','','','','',56,1,0,0,1441377254),(6,5,'0,5,',3,'','笔记本电脑','','','','','','','',64,1,0,0,1441377272),(7,5,'0,5,',3,'','智能手机','','','','','','','',7,1,0,0,1441377279),(8,0,'0,',3,'','成功案例','','','','','','','',144,1,0,0,1441065479),(9,0,'0,',1,'','联系我们','','/upload/origin/cms/2015-10/2.jpg','','','','','',1,1,0,0,1444572698),(10,9,'0,9,',1,'','联系我们摘要','','','','','','','',10,1,0,0,1444532727),(11,0,'0,',4,'','软件下载','','','','','','','',110,1,0,0,1441377104),(16,6,'',3,'','戴尔笔记本','','','','','戴尔笔记本','戴尔笔记本','戴尔笔记本',10,1,0,1440900636,1440917926),(18,0,'',2,'','文章测试','','','','','','','文章测试',10,1,0,1440918934,1444532774),(19,2,'',1,'','关于我们简述','','','','','','','关于我们简述',10,1,0,1440947151,1441377046),(20,19,'',1,'','关于我们简述的简述','','','','','','','关于我们简述的简述',10,1,0,1440947170,1441376858),(21,0,'',4,'','资料分亨','','','','','','','',10,1,0,1441340829,1441340829),(22,18,'',2,'','文章测试二','','','','','','','',10,1,0,1441375455,1441376870),(23,0,'',1,'','单页面测试','','','','','','','',10,1,0,1441378217,1441378268),(24,20,'',1,'','测试单页面子','','','','','','','',10,1,1,1441553888,1441553915),(25,0,'',1,'fee','收费标准','','','','','','','',10,1,0,1444578515,1444578515),(26,0,'',1,'flow','搬家流程','','','','','','','',10,1,0,1444578691,1444578691);
...
CREATE TABLE `t_cms_img` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='栏目图片类型表';

#
# Data for table "t_cms_img"
#

INSERT INTO `t_cms_img` VALUES (1,8,'苹果iPhone 4S 白色版','','','g','','admin','','白色版','','','templates/default/images/imgdata/iphone4s_w.jpg','',57,1,0,0,0,1326770071),(2,8,'苹果iphone 4s','','','g','','admin','','黑色版','','','templates/default/images/imgdata/iphone4s.jpg','',118,1,0,0,0,1326770089),(3,8,'苹果iPad 2 16GB/WIFI版','','','g','','admin','','16GB/WIFI版','','','templates/default/images/imgdata/ipad2.jpg','',85,1,0,0,0,1326770110),(4,8,'苹果iPod touch 4','','','g','','admin','','白色','','','templates/default/images/imgdata/iPod.jpg','',159,1,0,0,0,1326770133),(5,8,'苹果MacBook Pro','','','g','','admin','','MC725CH/A','','','templates/default/images/imgdata/macbook.jpg','',86,1,0,0,0,1326770162),(6,8,'苹果iMac','','','g','','admin','','MC814CH/A','','','templates/default/images/imgdata/iMac.jpg','',160,1,0,0,0,1326770178),(7,8,'361度——腾讯大运会梦想传递','','','g','','admin','','','火炬传递将是拉开2011年深圳世界大运会全民眼帘的幕布，政府首次以官方身份举办的网络虚拟火炬传递活动。将火炬虚拟传递举办成为深圳世界大运会的一次互联网传播盛会，361度借此机遇搭载腾讯大平台，迅速使其品牌在深圳世界大运会全面曝光，从而达到361度传播品牌，提升品牌形象的目的。','','templates/default/images/imgdata/361du.jpg','',107,1,0,0,0,1326770200),(8,8,'中华牙膏——我的微笑闪亮未来','','','g','','admin','','','这次活动将微博与微电影进行多种结合，充分调动用户与向微电影互动，通过看电影收集微笑金币，微博好友“出演”微电影，写下“我的未来”等，将中华牙膏“我的微笑 闪亮未来”的精神精准传递给受众。','','templates/default/images/imgdata/zhonghua.jpg','',195,1,0,0,0,1326770219),(9,8,'中国电信天翼——三星I559 I mini I life','','','g','','admin','','','作为电信天翼的定制手机，三星Galaxy 系列手机 Galaxy Mini上市之际，电信天翼希望借助腾讯的媒体平台和互动形式，直击年轻消费群体，实现产品对目标受众的充分曝光和产品卖点的有效深化 。','','templates/default/images/imgdata/I559.jpg','',143,1,0,0,0,1326770246),(10,8,'Moto——MT620两面派变身秀','','','g','','admin','','','Tahiti是MOTO推出的第一款将“触摸屏幕”和“QWERTY Bar”相结合的智能手机 ，为快速引发青年白领关注，MOTO借腾讯大平台，打造了一场“两面派变身秀”。','','templates/default/images/imgdata/moto.jpg','',116,1,0,0,0,1326770273),(11,8,'三一重工86米世界最长臂架泵车下线','','','g','','admin','','','','','templates/default/images/imgdata/slideimg_1.jpg','',64,1,0,0,0,1326770289),(12,8,'三一产品获八项第一','','','g','','admin','','','','','templates/default/images/imgdata/slideimg_2.jpg','',131,1,0,0,0,1326770306),(13,8,'三一获评《财富》十大“最受赞赏中国公司”','','','g','','admin','','','','','templates/default/images/imgdata/slideimg_3.jpg','',80,1,0,0,0,1326770336),(14,8,'唐家璇：三一重工为国家争了光','','','g','','admin','','','','','templates/default/images/imgdata/slideimg_4.jpg','',87,1,0,0,0,1326770383),(15,8,'亚洲首台千吨级全地面起重机SAC12000 2.0兆风电吊装圆满成功','','','g','','admin','','','','','templates/default/images/imgdata/slideimg_5.jpg','',53,1,0,0,0,1326770404),(16,8,'上传一个图片类型','#d72a2a','700','g','','jorry','','fasf','fsad','主体内容','','',100,1,0,0,1444533575,1441295302);
...
CREATE TABLE `t_extend_nav` (
  ...
  `updated_at` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='导航菜单';

#
# Data for table "t_extend_nav"
#

INSERT INTO `t_extend_nav` VALUES (1,0,'main','','','','',10,1,0,1444400585,1444572990),(2,1,'关于我们','http://turen.pw?r=site/page/view&name=about','','','',1,1,0,1444400622,1444576893),(3,1,'搬家流程','http://turen.pw?r=site/page/view&name=flow','','','',10,1,0,1444400661,1444578651),(4,1,'收费标准','http://turen.pw?r=site/page/view&name=fee','','','',10,1,0,1444400669,1444578557),(5,1,'案例展示','http://turen.pw?r=site/page/view&name=case','','','',10,1,0,1444400678,1444578796),(6,1,'在线预约','http://turen.pw?r=site/page/view&name=subscribe','','','',10,1,0,1444400717,1444578813),(7,1,'联系我们','http://turen.pw?r=site/page/view&name=contact','','','',10,1,0,1444400731,1444578828),(8,0,'sub-main','','','','',10,1,0,1444400761,1444406859),(9,8,'人才招聘','','','','',10,1,0,1444400808,1444400808),(10,8,'搬家常识','','','','',10,1,0,1444400848,1444401224),(11,8,'空调移机','','','','',10,1,0,1444400860,1444400860),(12,8,'长途货运','','','','',10,1,0,1444400869,1444400869),(13,8,'留言反馈','','','','',10,1,0,1444400883,1444400899),(14,8,'网站地图','','','','',10,1,0,1444400889,1444406075),(15,0,'bottom','','','','',10,1,0,1444573065,1444573065);
...
CREATE TABLE `t_order_call` (
  ...
  `order_note` varchar(255) DEFAULT NULL COMMENT '内页预约时填写的内容',
  `deleted` smallint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除',
  `created_at` int(11) unsigned NOT NULL DEFAULT '0',
  `updated_at` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='预约单';

#
# Data for table "t_order_call"
#

INSERT INTO `t_order_call` VALUES (49,37,'fish','0755-466857','留言测试',1,1441538842,1444923917),(50,37,'fish','0755-466857','留言测试',1,1441539040,1444924071),(51,37,'fish','0755-466857','留言测试',0,1441593217,1441593217),(52,37,'fish','0755-466857','留言测试',0,1441595399,1441595399),(58,37,'fish','0755-466857','留言测试',0,1441596365,1441596365),(59,37,'fish','0755-466857','留言测试',0,1441596365,1441596365),(60,37,'fish','0755-466857','留言测试',0,1441596366,1441855786),(61,37,'fish','0755-466857','留言测试',0,1441867708,1441867708),(62,37,'fish','0755-466857','留言测试',0,1441867708,1441867708),(65,37,'fish','0755-466857','留言测试',0,1441882429,1441882429),(66,37,'fish','0755-466857','留言测试',0,1441882429,1441882429),(67,37,'fish','0755-466857','留言测试',0,1441939775,1441939775),(68,37,'fish','0755-466857','留言测试',0,1441939775,1441939775),(69,37,'fish','0755-466857','留言测试',0,1441939895,1441939895),(70,37,'fish','0755-466857','留言测试',0,1441939895,1441939895),(71,37,'fish','0755-466857','留言测试',0,1441940040,1441940040),(72,37,'fish','0755-466857','留言测试',0,1441940040,1441940040),(74,37,'fish','0755-466857','空',0,1442213621,1442213621),(75,37,'fish','','',0,1442388435,1442388435),(81,37,'fish','','',0,1443000210,1443000210),(82,37,'fish','','',0,1443001045,1443001045),(83,37,'fish','','',1,1443001384,1443147892),(84,37,'fish','','',0,1443149357,1443149357);
...
INSERT INTO `t_order_info` VALUES (47,'ORDER_20150902035028',37,'夏又桥',1,6,77,0,'asfasdf','561455','13725514524','13725514524','980522557@qq.com','',5100.00,0.00,0,'',0,0,0,'',1,1441158628,1444924148),(48,'ORDER_20150906050345',37,'',0,0,0,0,'','','','','','',0.00,0.00,0,'',0,0,0,'',0,1441508626,1441508626),(49,'ORDER_20150906012722',37,'fish',0,0,0,0,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441538842,1441538842),(50,'ORDER_20150906013040',37,'fish',0,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441539040,1441539040),(51,'you-541561414-001',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441593217,1441593217),(52,'ORDER_20150907050959',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441595399,1441595399),(58,'ORDER_20150907052605744',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441596365,1441596365),(59,'ORDER_20150907052605239',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441596365,1441596365),(60,'ORDER_20150907052606967',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441596366,1441855786),(61,'ORDER_20150910084828842',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441867708,1441867708),(62,'ORDER_20150910084828783',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441867708,1441867708),(65,'ORDER_20150910125349443',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441882429,1441882429),(66,'ORDER_20150910125349547',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441882429,1441882429),(67,'ORDER_20150911044935745',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441939775,1441939775),(68,'ORDER_20150911044935468',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441939775,1441939775),(69,'ORDER_20150911045135181',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441939895,1441939895),(70,'ORDER_20150911045135861',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441939895,1441939895),(71,'ORDER_20150911045400862',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441940040,1441940040),(72,'ORDER_20150911045400476',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','留言测试',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1441940040,1441940040),(73,'ORDER_20150914085341804',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','空',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1442213621,1442213621),(74,'ORDER_20150914085341745',37,'fish',1,2,52,502,'南山科技园二期十栋4楼','438200','0755-466857','13725514524','980522557@qq.com','空',1210.00,0.00,0,'微信公众平台',0,0,0,'',0,1442213621,1442213621),(75,'yjt20150916032715163',37,'fish',1,2,52,502,'栽植asfsgfasdfasf','9585','','5159615','9845984','',5151.00,0.00,0,'',0,0,0,'',0,1442388435,1442388435),(76,'yjt20150918122212694',37,'fish',1,2,52,502,'9849494四方达sdfa','','','156455454','','',44154.00,0.00,0,'',0,0,0,'',0,1442550132,1442550132),(77,'yjt20150921052247467',37,'fish',1,2,52,502,'9849494四方达sdfa','','','156455454','','',84754.00,0.00,0,'111',0,0,0,'',0,1442827367,1442827367),(78,'yjt20150921052305142',37,'fish',1,2,52,502,'9849494四方达sdfa','','','156455454','','',84754.00,0.00,0,'111',0,0,0,'',0,1442827385,1442827385),(79,'yjt20150921052334664',37,'fish',1,2,52,502,'9849494四方达sdfa','','','156455454','','',84754.00,0.00,0,'111',0,0,0,'',0,1442827414,1442827414),(80,'yjt20150923041136155',43,'郭雄',1,6,77,707,'软件园2期，10栋，401','','','15172377475','','',0.01,0.00,0,'c-yz',0,0,0,'',0,1442995896,1442995896),(81,'yjt20150923052330175',37,'fish',1,2,52,502,'9849494四方达sdfa','','','156455454','','',84754.00,0.00,0,'111',0,0,0,'',0,1443000210,1443000210),(82,'yjt20150923053725833',37,'fish',1,2,52,502,'9849494四方达sdfa','','','156455454','','',84754.00,0.00,0,'111',0,0,0,'',0,1443001045,1443001045),(83,'yjt20150923054304595',37,'fish',1,2,52,502,'9849494四方达sdfa','','','156455454','','',84754.00,0.00,0,'111',0,0,0,'',1,1443001384,1443147892),(84,'yjt20150925104917552',37,'fish',1,2,52,502,'9849494四方达sdfa','','','156455454','','',84754.00,0.00,0,'111',0,0,0,'',0,1443149357,1443149357);
