...
('Administrator', '30', 1437631806),
('Administrator', '31', 1438569725),
('Administrator', '33', 1439182690),
('GAdministrator', '32', 1437636486);
...
('auth/auth', 3, 'Auth Auth Permission Group', NULL, NULL, 1440665360, 1440665360),
('GAdministrator', 1, '普通管理员', NULL, NULL, NULL, NULL),
('SEO', 1, '推广专员', NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `t_cms_ad` (
  ...
  `cms_ad_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '投放范围(广告位)',
  `title` varchar(30) NOT NULL COMMENT '广告标识',
  `mode` char(10) NOT NULL DEFAULT '' COMMENT '展示模式',
...
INSERT INTO `t_cms_ad` (`id`, `cms_ad_type_id`, `title`, `mode`, `pic_url`, `text`, `link_url`, `order`, `status`, `updated_at`, `created_at`) VALUES
(1, 1, 'QQ电脑管家', 'image', '', '', 'http://guanjia.qq.com/', 1, 1, 0, 1326771010),
(2, 2, '迅雷看看', 'image', '', '', 'http://www.xunlei.com/', 2, 1, 0, 1326771024);
...
CREATE TABLE IF NOT EXISTS `t_cms_ad_type` (
  ...
  `parent_str` varchar(50) NOT NULL DEFAULT '' COMMENT '上级id字符串',
  ...
  `order` smallint(5) unsigned NOT NULL DEFAULT '10' COMMENT '排列顺序',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='广告图类型表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `t_cms_ad_type`
--

INSERT INTO `t_cms_ad_type` (`id`, `parent_id`, `parent_str`, `name`, `width`, `height`, `order`, `status`) VALUES
(1, 0, '0,', '首页广告位', 1003, 80, 1, 1),
(2, 0, '0,', '子页广告位', 100, 70, 2, 1);
...
CREATE TABLE IF NOT EXISTS `t_cms_class` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='栏目表' AUTO_INCREMENT=16 ;

--
-- 转存表中的数据 `t_cms_class`
--

INSERT INTO `t_cms_class` (`id`, `parent_id`, `parent_str`, `type`, `name`, `link_url`, `pic_url`, `pic_width`, `pic_height`, `seo_title`, `keywords`, `description`, `order`, `status`, `deleted`, `created_at`, `updated_at`) VALUES
(1, 0, '0,', 1, '网站公告', '', '', '', '', '', '', '', 1, 1, 0, 0, 1440838732),
(2, 0, '0,', 1, '关于我们', '', '', '', '', '', '', '', 2, 1, 0, 0, 1440838741),
(4, 0, '0,', 2, '新闻动态', '', '', '', '', 'asdfaw', '', '', 4, 1, 0, 0, 1440816147),
(5, 0, '0,', 5, '产品展示', '', '', '', '', '', '', '', 5, 1, 0, 0, 1440816149),
(6, 5, '0,5,', 5, '笔记本电脑', '', '', '', '', '', '', '', 6, 1, 0, 0, 1440816150),
(7, 5, '0,5,', 5, '智能手机', '', '', '', '', '', '', '', 7, 1, 0, 0, 1440813471),
(8, 0, '0,', 3, '成功案例', '', '', '', '', '', '', '', 8, 1, 0, 0, 1440813458),
(9, 0, '0,', 1, '联系我们', '', '', '', '', '', '', '', 9, 1, 0, 0, 1440813434),
(10, 9, '0,9,', 1, '联系我们摘要', '', '', '', '', '', '', '', 10, 1, 0, 0, 1440818807),
(11, 0, '0,', 4, '软件下载', '', '', '', '', '', '', '', 11, 1, 0, 0, 1440813422),
(14, 3, '0,2,3,', 0, 'fasfasf', '', '', '', '', '', '', '', 12, 1, 0, 0, 0),
(15, 14, '0,2,3,14,', 0, 'asfasfd', '', '', '', '', '', '', '', 13, 1, 0, 0, 0);
...
INSERT INTO `t_cms_flag` (`id`, `flag`, `name`, `order`) VALUES
(1, 'h', '头条', 1),
(2, 'c', '推荐', 2),
(3, 'f', '幻灯', 3),
(4, 'a', '特荐', 4),
...
CREATE TABLE IF NOT EXISTS `t_cms_img` (
  ...
  `cms_class_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '所属栏目id',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='栏目图片类型表' AUTO_INCREMENT=16 ;

--
-- 转存表中的数据 `t_cms_img`
--

INSERT INTO `t_cms_img` (`id`, `cms_class_id`, `title`, `colorval`, `boldval`, `flag`, `source`, `author`, `link_url`, `keywords`, `description`, `content`, `pic_url`, `picarr`, `hits`, `order`, `status`, `updated_at`, `created_at`) VALUES
(1, 7, '苹果iPhone 4S 白色版', '', '', '', '', 'admin', '', '白色版', '', '', 'templates/default/images/imgdata/iphone4s_w.jpg', '', 57, 1, 0, 0, 1326770071),
(2, 7, '苹果iphone 4s', '', '', '', '', 'admin', '', '黑色版', '', '', 'templates/default/images/imgdata/iphone4s.jpg', '', 118, 2, 0, 0, 1326770089),
(3, 6, '苹果iPad 2 16GB/WIFI版', '', '', '', '', 'admin', '', '16GB/WIFI版', '', '', 'templates/default/images/imgdata/ipad2.jpg', '', 85, 3, 0, 0, 1326770110),
(4, 6, '苹果iPod touch 4', '', '', '', '', 'admin', '', '白色', '', '', 'templates/default/images/imgdata/iPod.jpg', '', 159, 4, 0, 0, 1326770133),
(5, 6, '苹果MacBook Pro', '', '', '', '', 'admin', '', 'MC725CH/A', '', '', 'templates/default/images/imgdata/macbook.jpg', '', 86, 5, 0, 0, 1326770162),
(6, 6, '苹果iMac', '', '', '', '', 'admin', '', 'MC814CH/A', '', '', 'templates/default/images/imgdata/iMac.jpg', '', 160, 6, 0, 0, 1326770178),
(7, 8, '361度——腾讯大运会梦想传递', '', '', '', '', 'admin', '', '', '火炬传递将是拉开2011年深圳世界大运会全民眼帘的幕布，政府首次以官方身份举办的网络虚拟火炬传递活动。将火炬虚拟传递举办成为深圳世界大运会的一次互联网传播盛会，361度借此机遇搭载腾讯大平台，迅速使其品牌在深圳世界大运会全面曝光，从而达到361度传播品牌，提升品牌形象的目的。', '', 'templates/default/images/imgdata/361du.jpg', '', 107, 7, 0, 0, 1326770200),
(8, 8, '中华牙膏——我的微笑闪亮未来', '', '', '', '', 'admin', '', '', '这次活动将微博与微电影进行多种结合，充分调动用户与向微电影互动，通过看电影收集微笑金币，微博好友“出演”微电影，写下“我的未来”等，将中华牙膏“我的微笑 闪亮未来”的精神精准传递给受众。', '', 'templates/default/images/imgdata/zhonghua.jpg', '', 195, 8, 0, 0, 1326770219),
(9, 8, '中国电信天翼——三星I559 I mini I life', '', '', '', '', 'admin', '', '', '作为电信天翼的定制手机，三星Galaxy 系列手机 Galaxy Mini上市之际，电信天翼希望借助腾讯的媒体平台和互动形式，直击年轻消费群体，实现产品对目标受众的充分曝光和产品卖点的有效深化 。', '', 'templates/default/images/imgdata/I559.jpg', '', 143, 9, 0, 0, 1326770246),
(10, 8, 'Moto——MT620两面派变身秀', '', '', '', '', 'admin', '', '', 'Tahiti是MOTO推出的第一款将“触摸屏幕”和“QWERTY Bar”相结合的智能手机 ，为快速引发青年白领关注，MOTO借腾讯大平台，打造了一场“两面派变身秀”。', '', 'templates/default/images/imgdata/moto.jpg', '', 116, 10, 0, 0, 1326770273),
(11, 13, '三一重工86米世界最长臂架泵车下线', '', '', '', '', 'admin', '', '', '', '', 'templates/default/images/imgdata/slideimg_1.jpg', '', 64, 11, 0, 0, 1326770289),
(12, 13, '三一产品获八项第一', '', '', '', '', 'admin', '', '', '', '', 'templates/default/images/imgdata/slideimg_2.jpg', '', 131, 12, 0, 0, 1326770306),
(13, 13, '三一获评《财富》十大“最受赞赏中国公司”', '', '', '', '', 'admin', '', '', '', '', 'templates/default/images/imgdata/slideimg_3.jpg', '', 80, 13, 0, 0, 1326770336),
(14, 13, '唐家璇：三一重工为国家争了光', '', '', '', '', 'admin', '', '', '', '', 'templates/default/images/imgdata/slideimg_4.jpg', '', 87, 14, 0, 0, 1326770383),
(15, 13, '亚洲首台千吨级全地面起重机SAC12000 2.0兆风电吊装圆满成功', '', '', '', '', 'admin', '', '', '', '', 'templates/default/images/imgdata/slideimg_5.jpg', '', 53, 15, 0, 0, 1326770404);
...
CREATE TABLE IF NOT EXISTS `t_cms_list` (
...
CREATE TABLE IF NOT EXISTS `t_cms_page` (
  ...
  `created_at` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='单页面类型表' AUTO_INCREMENT=6 ;

--
-- 转存表中的数据 `t_cms_page`
--

INSERT INTO `t_cms_page` (`id`, `cms_class_id`, `title`, `pic_url`, `content`, `order`, `status`, `updated_at`, `created_at`) VALUES
(1, 1, '', '', '测试信息来自互联网，若涉及侵权，请联系我们删除！', 10, 1, 0, 1326769494),
...
CREATE TABLE IF NOT EXISTS `t_customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='前台用户表' AUTO_INCREMENT=41 ;
...
(37, 5, '夏又桥', 'jorry', 1, 525650400, '980522557@qq.com', '13725514524', '13725514524', 100, 4, 'VzZG11IoY771oA-VGCSfjjNDVknCcweS', '$2y$13$Z9CkShCmn3VkRAneNRQqeeAQVlTjQ4twVmU80iWfP4USCbX36nGza', NULL, 1, 1436861752, 1437960208, 0, 0),
...
('3u5gtlah3c5i58jjglifnpsdu5', 1440842663, 0x5f5f666c6173687c613a303a7b7d5f5f69647c693a33303b),
('9suu0f4rc2nhkapj45igbu1uh4', 1440842653, ),
('chcce049a7581aj3rvregkndl4', 1440902501, 0x5f5f666c6173687c613a303a7b7d5f5f69647c693a33303b);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='系统配置表' AUTO_INCREMENT=650 ;
...
(634, '站点名称', 'any', 'config_site_name', '土人内容管理系统', 1, 0),
...
(644, '允许访问动作', 'access', 'config_access_action', 'notify,open-get-send-file', 1, 0),
...
(649, '上传图片大小', 'pic', 'config_pic_size', '500KB', 1, 0);
...
(30, 8, 1, 'jorry', '夏又桥', 'PbSLNPQ0B4EO0rgt7Ie53_ZNrsOipI_X', '$2y$13$5f4GeOsMO71jW3g03N92ye6JQet9Z2aj8.N7FvS2a.Hb72ASHomwq', NULL, '980522557@qq.com', 'Administrator', 1, 1437442547, 1437631806),
(31, 10, 0, 'fish', '张鱼', '6wgWk3-J-j-K7hfYbY3cTOf4hOBX782H', '$2y$13$22vLOQ/Y4DrMf4ybgzYpcOJjOCXOzB5xEhljlQVlK9NRRZQxU6MDu', NULL, '222@qq.com', 'Administrator', 1, 1437444357, 1438569725),
(32, 8, 0, 'xiong123', '郭熊', 'Z4AlVGre3znusvIJe22yxymcm2zxXbS8', '$2y$13$9tbtEr7uOD8Zpho.qTpp5uJYEheMUU4xCAm6Z/OBoI8g5/TsxhAj6', NULL, '51@qq.com', 'GAdministrator', 1, 1437444402, 1437636486);
