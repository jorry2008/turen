...
<div class="list">
    ...
    <?= Html::a(General::showImg($model->pic_url, 'c', $model->title, 'px', 140, 102), ['/site/post/view', 'id'=>$model->id], ['class'=>'img' ,'title'=>$model->title]) ?>
    <div class="list_detail">
    	...
    	?>
    	<?= Html::a(StringHelper::truncate($model->title, $length), ['/site/post/view', 'id'=>$model->id], ['class'=>'title', 'title'=>$model->title, 'style'=>$options['style']]) ?>
        ...
        <div class="cont">
        	...
        	?>
            <?= Html::a('详情', ['/site/post/view', 'id'=>$model->id], ['rel'=>'nofollow']) ?>
        </div>
