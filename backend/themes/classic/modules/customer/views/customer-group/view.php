    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content clearfix">
                <div class="tab-pane active customer-group-view">
            <p>
            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        ...
                        'value' => $model->is_default ? Yii::t('common', 'Default') : Yii::t('common', 'Not Default'),
                    ], [
                        'attribute' => 'approval',
                        'value' => $model->approval ? Yii::t('common', 'Passed') : Yii::t('common', 'Forbid'),
                    ],
                    'sort',
                ],
            ]) ?>
