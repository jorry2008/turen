...
$this->title = Yii::t('customer', 'Update Customer') . ' ' . $model->username;
$this->params['breadcrumbs'][] = ['label' => Yii::t('customer', 'Customer List'), 'url' => ['index']];
    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content clearfix">
                <div class="tab-pane active customer-update">
