...
// 	});
	...
	//select2
// 	$('#cmsdownload-cms_class_id').select2({
//         theme: 'classic',
//         width: '400px',
//     });
...
<div class="row cms-download-form">
	<div class="col-md-12">
        ...
        <?= $form->field($model, 'cms_class_id')->dropDownList(ArrayHelper::map(CmsClass::find()->where(['type'=>CmsClass::CMS_TYPE_DOWNLOAD])->alive()->all(), 'id', 'name')) ?>
