...
$this->title = Yii::t('cms', 'Update:') . $model->cmsClass->name;
$this->params['breadcrumbs'][] = ['label' => Yii::t('cms', 'Cms Page List'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->cmsClass->name, 'url' => ['view', 'id' => $model->id]];
