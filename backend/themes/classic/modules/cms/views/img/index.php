...
/* @var $searchModel common\models\cms\ImgSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('cms', 'Img List');
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content clearfix">
                <div class="tab-pane active cms-img-index">
                    ...
                    <!-- 
                        <p>
                            <?= Html::a(Yii::t('cms', 'Create Img'), ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                     -->
                        ...
                        'columns' => [
                        	...
                        	[
                        		...
                        		'value' => function($model){
                            		...
                            		'attribute' => 'column_id',
                            		'filter' => ArrayHelper::map(Column::find()->where(['type'=>Column::CMS_TYPE_IMG])->alive()->all(), 'id', 'name'),
