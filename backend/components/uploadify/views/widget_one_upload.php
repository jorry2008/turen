...
<!--     [ -->
<!-- 	    	'inputTemplate' => '<div class="input-group">{input}<span class="upload_picture" class="input-group-addon"><span title="'.Yii::t('cms', 'Upload picture').'"><i class="fa fa-upload"></i></span></div>', -->
<!--     	] -->
