...
/**
 * ImgSearch represents the model behind the search form about `common\models\cms\Img`.
 */
class ImgSearch extends Img
{
    ...
    {
        return [
            [['id', 'column_id', 'hits', 'status', 'updated_at', 'created_at'], 'integer'],
            [['title', 'flag', 'colorval', 'boldval', 'source', 'author', 'link_url', 'keywords', 'description', 'content', 'pic_url', 'picarr'], 'safe'],
        ];
    }
