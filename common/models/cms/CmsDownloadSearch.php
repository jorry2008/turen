...
/**
 * CmsDownloadSearch represents the model behind the search form about `common\models\cms\CmsDownload`.
 */
class CmsDownloadSearch extends CmsDownload
{
    /**
     * @inheritdoc
     */
